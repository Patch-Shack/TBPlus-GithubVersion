...
local IconController = loadstring(game:HttpGetAsync(("https://raw.githubusercontent.com/Patch-Shack/TBPlus-GithubVersion/main/IconController.lua")))();
local Signal = loadstring(game:HttpGetAsync(("https://raw.githubusercontent.com/Patch-Shack/TBPlus-GithubVersion/main/Signal.lua")))();
local Maid = loadstring(game:HttpGetAsync(("https://raw.githubusercontent.com/Patch-Shack/TBPlus-GithubVersion/main/Maid.lua")))();
local TopbarPlusGui = loadstring(game:HttpGetAsync(("https://raw.githubusercontent.com/Patch-Shack/TBPlus-GithubVersion/main/TopbarPlusGui.lua")))();
local TopbarPlusReference = loadstring(game:HttpGetAsync(("https://raw.githubusercontent.com/Patch-Shack/TBPlus-GithubVersion/main/TopbarPlusReference.lua")))();
local referenceObject = TopbarPlusReference.getObject()
local Themes = loadstring(game:HttpGetAsync(("https://raw.githubusercontent.com/Patch-Shack/TBPlus-GithubVersion/main/Themes.lua")))();
